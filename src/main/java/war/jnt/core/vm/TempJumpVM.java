 ...
 * Wraps arithmetic operations in a goto-based C VM dispatcher with
 * polymorphic obfuscation math layers around each operation.
 *
 * Supports both int (32-bit) and long (64-bit) operations.
 *
 * @author jan
 */
